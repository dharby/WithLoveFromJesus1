        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <FadeIn direction="right" className="space-y-6 text-lg text-foreground/80 font-sans leading-relaxed">
              ...
              <p>
                In many remote regions, the journey to a clinic is too far, too expensive, or entirely inaccessible. Preventable complications during pregnancy and childbirth remain tragically high simply because basic care is not within reach.
              </p>
              <p>
            ...
            <FadeIn direction="left">
              <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-[3/4] md:aspect-[4/3]">
                <img src={health1} alt="Pregnant mother in traditional attire" className="w-full h-full object-cover object-top" />
              </div>
            </FadeIn>
          </div>
        </div>
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <StaggerItem className="bg-card p-8 rounded-2xl border border-border shadow-sm">
              ...
              <p className="text-foreground/70 font-sans leading-relaxed">
                Regular checkups, vital monitoring, and medical supervision throughout pregnancy to ensure the safety of both mother and child.
              </p>
            </StaggerItem>
            ...
            <StaggerItem className="bg-card p-8 rounded-2xl border border-border shadow-sm">
              ...
              <p className="text-foreground/70 font-sans leading-relaxed">
                Provision of vitamins, supplements, safe birthing kits, and essential medications for maternal wellbeing.
              </p>
            </StaggerItem>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <FadeIn direction="left" className="order-1 lg:order-2 space-y-6 text-lg text-foreground/80 font-sans leading-relaxed">
              ...
              <div className="bg-accent/10 border border-accent/20 p-6 rounded-xl mt-8">
                <p className="font-serif italic text-xl text-primary mb-2">"When the mobile clinic arrived, I was able to hear my baby's heartbeat for the first time. They gave me the vitamins I could not afford."</p>
